...
var _default = (0, _vue.defineComponent)({
  ...
  setup(props) {
    ...
    var checkAmpm = ampmType => {
      ...
      var newTime = (0, _shared2.padStart)(newHour, 2, '0') + ":" + time.value.minute + second;
      update(newTime);
    };
    ...
    (0, _vue.watch)(() => props.modelValue, value => {
      if (value) {
        ...
        if (props.format !== '24hr') {
          ampm.value = (0, _shared2.padStart)("" + hour, 2, '0') === formatHour24 && _props.hours24.includes(formatHour24) ? 'pm' : 'am';
        }
