...
function render(_ctx, _cache) {
  ...
  /* CLASS */
  )) : (0, _vue.createCommentVNode)("v-if", true), _ctx.$slots['floating-content'] && !_ctx.isRow ? ((0, _vue.openBlock)(), (0, _vue.createElementBlock)("div", {
    key: 1,
    class: (0, _vue.normalizeClass)(_ctx.n('floating-content')),
    style: (0, _vue.normalizeStyle)({
      height: _ctx.contentHeight,
      opacity: _ctx.opacity,
      transition: "opacity " + _ctx.floatingDuration * 2 + "ms"
    })
  }, [(0, _vue.renderSlot)(_ctx.$slots, "floating-content")], 6
  /* CLASS, STYLE */
